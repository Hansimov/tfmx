"""Reusable network and mirror settings for QSR builds and runtime."""
...
class QSRNetworkConfig:
    ...
    def from_overrides(
        ...
        resolved_pip_trusted_host = (
            pip_trusted_host
            or _read_env(
                "TFMX_QSR_PIP_TRUSTED_HOST",
                "QSR_PIP_TRUSTED_HOST",
                "PIP_TRUSTED_HOST",
            )
